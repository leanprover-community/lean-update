...
1. This Action first installs [elan](https://github.com/leanprover/elan) and runs `lake update`. This fetches the latest Lean release and updates all dependent packages to their latest versions.
